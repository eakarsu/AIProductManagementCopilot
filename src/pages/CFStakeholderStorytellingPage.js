...
// Custom Feature: Stakeholder storytelling
// Stakeholder storytelling: Auto-generate compelling narratives around product decisions; customize per stakeholder (executive, engineer, customer); drive alignment
import React, { useState } from 'react';

export default function CFStakeholderStorytellingPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-stakeholder-storytelling/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Stakeholder storytelling</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Stakeholder storytelling: Auto-generate compelling narratives around product decisions; customize per stakeholder (executive, engineer, customer); drive alignment</p>
